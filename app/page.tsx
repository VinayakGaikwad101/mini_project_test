...
import {
  ...
  Cpu,
  ShieldCheck,
  Trash2, // Icon for the Clear button
} from "lucide-react";

// --- THE "THEATRICS": Tech-Savvy Loading Sequence ---
const LOADING_STEPS = [
...
export default function Home() {
  ...
  const startLoadingSequence = () => {
    ...
    // CHANGE: Rotate text every 5000ms (5 seconds)
      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-100">
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="space-y-4">
            ...
            {/* STATUS BAR (Visible when loading) */}
            {loading && (
              <div className="flex items-center justify-center gap-3 bg-slate-50 p-3 rounded-lg border border-slate-100 animate-in fade-in slide-in-from-top-2">
                ...
                {/* Text is dark slate (black-ish) for readability */}
